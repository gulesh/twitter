...
class HomeTableTableViewController: UITableViewController {
    ...
    //this function will load the twets into my array dictionary
       @objc func loadtweets(){
           ...
           // pulls the dictionary array from th URL
           TwitterAPICaller.client?.getDictionariesRequest(url: myUrl, parameters: myParams, success: { (tweets: [NSDictionary]) in
               
               self.tweetArray.removeAll()
               //copies all the content of Dictionary Array from the URl to my variable tweetArray
               for tweet in tweets{
               ...
               print("Error while retreving tweets")
           })
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        userDict = tweetArray[indexPath.row]["user"] as! NSDictionary
